...
2. **Write a brief description of each task scenario.** Be sure to include:
   ...
   * at least one possible method to measure or evaluate the robot's performance during the task — such as:
     ...
     * **errors** \(e.g., robot will have 0 collisions with obstacles, etc.\)
...
{% hint style="success" %}
**CLEAR THE WAY:**  The robot needs a path that is about 18" \(1.5 feet\) wide in order to drive forward and make turns. If you place walls and other obstacles too close together, your robot might not be able to navigate through them.
{% endhint %}
