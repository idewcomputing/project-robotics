...
This pseudocode example is based on the example task scenario diagram from assignment 1.7. It uses plain language to describe the specific steps in order that the robot will need to perform to complete the task. 
