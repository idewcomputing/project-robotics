...
3. Identify which specific [types of robot behaviors](https://docs.idew.org/code-robotics/references/robot-behaviors) that your robot prototype will need to perform to complete its tasks.
